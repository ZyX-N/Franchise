...
export default function ContactPopUp({ setOpen }: { setOpen: any }) {
  return (
    <div className="size-full flex items-center justify-center bg-[rgba(0,0,0,0.3)]">
      <div className="w-4/5 sm:w-3/4 h-[90%] overflow-x-hidden relative flex flex-col items-center justify-center bg-white overflow-y-auto pt-48 sm:pt-28 rounded-lg custom-scrollbar shadow-lg shadow-gray-800">
        <button
          type="button"
